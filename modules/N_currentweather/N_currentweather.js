...
/* Magic Mirror
 * Module: N_CurrentWeather
 *
 * By Nycko
 */

Module.register("N_currentweather",{
	...
	updateWeather: function() {
		...
		//var url = "wthrcdn.etouch.cn/weather_mini?city=深圳"
	...
	processWeather: function(data) {
		...
		if (windInMph > 3 && tempInF < 50){
			...
			// this.feelsLike = windChillInC.toFixed(0);//格式化不适用指数形式表示，并且0个小数位
